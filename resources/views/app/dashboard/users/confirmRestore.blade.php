...
@section('title', Lang::get('Confirm Restore'))
    ...
    <div class="container-fluid">
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">{{ __("Do you really want to activate this user") }}?</h6>
                </div>
        ...
        <div class="row justify-content-center fadeInTransition" >
            <div class="card col-6 bg-secondary shadow border-0">
                    ...
                    <strong>
                        *
                        <span class="text-muted">
                            {{ __("This user will be activated. He can log in and make changes to the system.") }}
                        </span>
                        *
                    </strong>
                </div>
                ...
                <form action="{{ route('users.restore', $user->id)}}" class="form-loader"  method="POST">
                    @csrf
                    @method('PUT')
