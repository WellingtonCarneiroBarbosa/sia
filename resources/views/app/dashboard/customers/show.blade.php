...
@section('title', Lang::get('View Customer'))
    ...
    <div class="container-fluid">
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">{{ __("View Customer") }}</h6>
                </div>
        ...
        <div class="row justify-content-center fadeInTransition" >
            <div class="card col-6 bg-secondary shadow border-0">
                ...
                <div class="text-center text-danger"><h3>{{ __("More details about") }} <u>{{ $customer->corporation }}</u> </h3></div>
                <hr>
