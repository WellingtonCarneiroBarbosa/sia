...
<head>
    ...
    --
    -->
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('home-elements/assets/img/brand/siaLogo.png') }}">
    <link rel="icon" type="image/png" href="{{ asset('home-elements/assets/img/brand/siaLogo.png') }}">
            ...
            <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
                <div class="container-fluid">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <!-- Search form -->
                        <form id="form" class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
                        ...
                        <ul class="navbar-nav align-items-center  ml-md-auto ">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
                                    <!-- Dropdown header -->
                                    <div class="px-3 py-3">
                                        <h6 class="text-sm text-muted m-0">{{ __("You have") }}<strong class="text-primary">1</strong> {{ __("unread conversations") }}.</h6>
                                    </div>
                                    <!-- List group -->
